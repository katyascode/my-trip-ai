...
const UploadPage = () => {
    ...
    const profileFiles = latestProfile ? uploadedFiles.filter(file => file.profileId === latestProfile.id) : [];
    ...
    const handleSubmit = (event) => {
        ...
        // Add file to Zustand store with trip and profile association
        addFile({
            file: selectedFile,
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-pink-600 text-center">
                {!latestProfile ? (
                    <div className="text-center">
                        <p className="text-gray-500 mb-4">Please create a profile first to upload documents.</p>
                        <Button
                            title="Create Profile"
                            colourClass="green"
                            link="/trips/profile/register"
                        />
                    </div>
                ) : (
                    <>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    {trips
                                        .filter(trip => trip.profileId === latestProfile.id)
                                        .map((trip) => (
