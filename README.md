...
Then, run ```npm run dev``` in the IDE console or your terminal to start the project on a local development server. 
...
When uploading documents, please only upload .docx files as our document parser cannot handle other file types at the moment. 
For all other inputs, there are no specific instructions as this is a fully functional prototype. 
